...
python -m pytest tests/test_evidence_schema_contract.py tests/test_research_quality_backtest.py tests/test_report_template_config.py tests/test_web_news_quality_contract.py -q
```
