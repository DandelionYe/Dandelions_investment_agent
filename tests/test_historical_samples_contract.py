...
class TestSampleSchema:
    ...
    def test_quality_flags_set(self, samples):
        for s in samples:
            q = s.get("quality", {})
...
class TestScenarioTagCoverage:
    ...
    def test_all_required_tags_present(self, samples):
        covered = set()
        for s in samples:
    ...
    def test_has_etf_samples(self, samples):
    ...
    def test_has_small_or_mid_cap(self, samples):
    ...
    def test_has_industry_insufficient(self, samples):
